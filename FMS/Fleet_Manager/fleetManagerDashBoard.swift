...
func generateExampleTrips() -> [Trip] {
    ...
    let vehicle1 = Vehicle(type: .car, model: "", registrationNumber: "", fuelType: .diesel, mileage: 1, rc: "", vehicleImage: "", insurance: "", pollution: "", status: false, totalDistance: 0, maintenanceStatus: .scheduled)
